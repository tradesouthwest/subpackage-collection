...
Installing "subpackage-collection" can be done either by searching for "subpackage-collection" via the "Plugins > Add New" screen in your WordPress dashboard, or by using the following steps:
